...
#         tn=0
#         
#         I1 = ((t1 >= ts1) and (t1 < te1)) #Pride med 0.00 in 5.99
#         II1 =  ((t1 >= te1) and (t1 < ts2)) #Pride med 6.00 in 21.99
#         III1 = ((t1 >= ts2) and (t1 < te2)) #Pride med 22.00 in 22.00+8đ
#         
#         I2 = ((t2 > ts1) and (t2 <= te1)) #Gre med 0.00 in 5.99
#         II2 =  ((t2 > te1) and (t2 <= ts2)) #Gre med 6.00 in 21.99
#         III2 = ((t2 > ts2) and (t2 <= te2)) #Gre med 22.00 in 22.00+8
#         
#         
#         IV = ((t2 > te2) and (t2 <= 48)) #Med 22.00+8 in 48
#         
#         if t1 >= t2:
#             t2 = t2 + 24 #prekoracitev polnoci  
#             
#         #t1:I, t2: I -> Came and left between 0.00 and 5.59
#         if (I1) and (I2): 
#             tn = t2 - t1
#         #t1:I, t2: II -> Came between 0.00 and 5.59 and left between 6.00 and 21.59
#         if (I1) and (II2):
#             tn = te1 - t1
#         #t1:I, t2: III  > Came between 0.00 and 5.59 and left between 22.00 and 22.00+8
#         if (I1) and (III2):
#             tn =(te1 - t1) + (t2 - ts2)  
#         #t1:I, t2: IV ->  Came between 0.00 and 5.59 and left between 22.00+8 and 48
#         if (I1) and (IV):
#             tn =(te1 - t1) + (te2 - ts2)
#             
#         #t1:II, t2: II -> Came and left between 6.00 and 21.59
#         if (II1) and (II2):
#             tn = 0 
#         #t1:II, t2: III -> Came between 6.00 and 21.59 and left between 22.00 and 22.00+8
#         if (II1) and (III2):
#             tn = t2 - ts2      
#         #t1:II, t2: IV -> Came between 6.00 and 21.59 and left between 22.00+8 and 48
#         if (II1) and (IV):
#             tn = te2 - ts2
#             
#         #t1:III, t2: III -> Came and left between 22.00 and 22.00+8
#         if (III1) and (III2):
#             tn = t2 - t1  
#         #t1:III, t2: IV -> Came between 22.00 and 22.00+8 and left between 22.00+8 and 48
#         if (III1) and (IV):  
#             tn = te2 - t1
#             
#         #t1:IV, t2: IV
